...
// 4. Live Map with OpenStreetMap Integration
const LiveMapPage = () => {
  // Use actual accident data with real Coimbatore coordinates
  const [accidents, setAccidents] = useState(MOCK_REPORTS);
  ...
  return (
    <div className="h-screen w-full pt-16">
      <InteractiveLiveMap
        accidents={accidents}
        onMarkerClick={(accident) => console.log('Clicked:', accident)}
      />
    </div>
  );
};
